...
pactl set-default-source $OUTPUT_SOURCE_AUDIO_DEV.echo-cancel
...
ffmpeg -hide_banner -stream_loop -1 -f $OUTPUT_SOURCE_VIDEO_TYPE -video_size $OUTPUT_SOURCE_VIDEO_RES\
 ...
 -f $OUTPUT_SOURCE_AUDIO_TYPE -i $OUTPUT_SOURCE_AUDIO_DEV.echo-cancel -map 0:v:0 -map 1:a:0 -s 1920x1080 -g 30\
 -vcodec $OUTPUT_DEST_VIDEO_CODEC -acodec $OUTPUT_DEST_AUDIO_CODEC -b:v $OUTPUT_DEST_VIDEO_BITRATE\
